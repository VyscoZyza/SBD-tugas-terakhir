					...
					?>
						<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
							<div class="card card-signin my-5">
								<div class="card-body">
									<h5 class="card-title text-center">Edit Data Dosen</h5>
										<form class="form-signing" action="updateDsn.php" method="post">
											<div class="form-label-group">
											<label>NIP</label>
												<input type="number" name="nip" value="<?php echo $data['nip'] ?>" class="form-control" required autofocus>
												</div><br>
												...
												<label>Alamat</label>
												<div class="form-label-group">
												<input type="text" name="kepakaran" value="<?php echo $data['kepakaran'] ?>"class="form-control" required>
												</div>
												<br>
